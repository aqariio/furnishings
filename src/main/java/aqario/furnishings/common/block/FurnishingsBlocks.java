...
public class FurnishingsBlocks {
    ...
    public static final Block BRAZIER = register("brazier", new BrazierBlock(true, 1, QuiltBlockSettings.create().strength(3.0f).sounds(BlockSoundGroup.METAL).requiresTool().luminance((state) -> state.get(BrazierBlock.LIT) ? 15 : 0).nonOpaque()), ItemGroups.FUNCTIONAL_BLOCKS);
    public static final Block SOUL_BRAZIER = register("soul_brazier", new BrazierBlock(false, 2, QuiltBlockSettings.create().strength(3.0f).sounds(BlockSoundGroup.METAL).requiresTool().luminance((state) -> state.get(BrazierBlock.LIT) ? 10 : 0).nonOpaque()), ItemGroups.FUNCTIONAL_BLOCKS);
    ...
    public static final Block CANDELABRA = register(
        "candelabra",
        new CandelabraBlock(QuiltBlockSettings.create().nonOpaque().strength(2.0F).sounds(BlockSoundGroup.LANTERN).luminance(CandelabraBlock.STATE_TO_LUMINANCE)), ItemGroups.FUNCTIONAL_BLOCKS
    );
    ...
    public static final Block WHITE_CUSHION = register(
        "white_cushion",
        new CushionBlock(QuiltBlockSettings.create().mapColor(MapColor.WOOL).strength(0.2F).sounds(FurnishingsSoundEvents.FurnishingsBlockSoundGroup.CUSHION).pistonBehavior(PistonBehavior.DESTROY)), ItemGroups.FUNCTIONAL_BLOCKS
    );
    public static final Block ORANGE_CUSHION = register(
        "orange_cushion",
        new CushionBlock(QuiltBlockSettings.create().strength(0.2F).sounds(FurnishingsSoundEvents.FurnishingsBlockSoundGroup.CUSHION).pistonBehavior(PistonBehavior.DESTROY)), ItemGroups.FUNCTIONAL_BLOCKS
    );
    ...
    public static final Block MUG = register("mug", new MugBlock(QuiltBlockSettings.create().breakInstantly().luminance(state -> state.get(FluidContainerBlock.LUMINANCE)).sounds(BlockSoundGroup.WOOD).pistonBehavior(PistonBehavior.DESTROY)), ItemGroups.FUNCTIONAL_BLOCKS);
    public static final Block CHALICE = register("chalice", new ChaliceBlock(QuiltBlockSettings.create().breakInstantly().luminance(state -> state.get(FluidContainerBlock.LUMINANCE)).sounds(BlockSoundGroup.LANTERN).pistonBehavior(PistonBehavior.DESTROY)), ItemGroups.FUNCTIONAL_BLOCKS);
    ...
    public static final Block POLISHED_TUFF_BRICKS = register("polished_tuff_bricks", new Block(QuiltBlockSettings.copyOf(Blocks.TUFF)), ItemGroups.BUILDING_BLOCKS);
    public static final Block POLISHED_TUFF_BRICK_SLAB = register("polished_tuff_brick_slab", new SlabBlock(QuiltBlockSettings.copyOf(POLISHED_TUFF_BRICKS)), ItemGroups.BUILDING_BLOCKS);
    public static final Block POLISHED_TUFF_BRICK_STAIRS = register("polished_tuff_brick_stairs", new StairsBlock(POLISHED_TUFF_BRICKS.getDefaultState(), QuiltBlockSettings.copyOf(POLISHED_TUFF_BRICKS)), ItemGroups.BUILDING_BLOCKS);
    public static final Block POLISHED_TUFF_BRICK_WALL = register("polished_tuff_brick_wall", new WallBlock(QuiltBlockSettings.copyOf(POLISHED_TUFF_BRICKS)), ItemGroups.BUILDING_BLOCKS);
    public static final Block CRACKED_POLISHED_TUFF_BRICKS = register("cracked_polished_tuff_bricks", new Block(QuiltBlockSettings.copyOf(POLISHED_TUFF_BRICKS)), ItemGroups.BUILDING_BLOCKS);
