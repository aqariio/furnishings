...
//						this,
//						new StatueEntityModel(ctx.getPart(EntityModelLayers.ARMOR_STAND_INNER_ARMOR)),
//						new StatueEntityModel(ctx.getPart(EntityModelLayers.ARMOR_STAND_OUTER_ARMOR))
//				)
//		);
