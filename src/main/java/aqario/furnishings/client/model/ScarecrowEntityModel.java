...
public class ScarecrowEntityModel extends BipedEntityModel<ScarecrowEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData stand = modelPartData.addChild(
			STAND,
	...
	public void setAngles(ScarecrowEntity scarecrowEntity, float f, float g, float h, float i, float j) {
		this.body.getChild(EntityModelPartNames.HEAD).pitch = (float) (Math.PI / 180.0) * scarecrowEntity.getHeadRotation().getPitch();
		this.body.getChild(EntityModelPartNames.HEAD).yaw = (float) (Math.PI / 180.0) * scarecrowEntity.getHeadRotation().getYaw();
		this.body.getChild(EntityModelPartNames.HEAD).roll = (float) (Math.PI / 180.0) * scarecrowEntity.getHeadRotation().getRoll();
		...
		this.body.getChild(EntityModelPartNames.LEFT_ARM).pitch = (float) (Math.PI / 180.0) * scarecrowEntity.getLeftArmRotation().getPitch();
		this.body.getChild(EntityModelPartNames.LEFT_ARM).yaw = (float) (Math.PI / 180.0) * scarecrowEntity.getLeftArmRotation().getYaw();
		this.body.getChild(EntityModelPartNames.LEFT_ARM).roll = (float) (Math.PI / 180.0) * scarecrowEntity.getLeftArmRotation().getRoll();
		this.body.getChild(EntityModelPartNames.RIGHT_ARM).pitch = (float) (Math.PI / 180.0) * scarecrowEntity.getRightArmRotation().getPitch();
		this.body.getChild(EntityModelPartNames.RIGHT_ARM).yaw = (float) (Math.PI / 180.0) * scarecrowEntity.getRightArmRotation().getYaw();
		this.body.getChild(EntityModelPartNames.RIGHT_ARM).roll = (float) (Math.PI / 180.0) * scarecrowEntity.getRightArmRotation().getRoll();
